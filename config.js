...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "4S8xQC4T#5FH1LrpssLSvB5oTOlAxiXzIk62c3iUxO396cVZ93NE",
    ...
    PACKNAME: (process.env.PACK_INFO?.split(';') || [])[1] || 2347045298226',
    ...
    DEV: process.env.DEV || "2347045298226", //replace with your whatsapp number
